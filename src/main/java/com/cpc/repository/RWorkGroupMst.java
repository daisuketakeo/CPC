...
public interface RWorkGroupMst{
    ...
    @Select({
     "<script>",
        ...
        "      AND WORK_GROUP = #{WORK_GROUP}",
        "    </if>",
        "    <if test='WORK_GROUP_NAME != &quot;&quot; and WORK_GROUP_NAME != null'>",
        "      AND WORK_GROUP_NAME = #{WORK_GROUP_NAME}",
        "    </if>",
        "    <if test='BEFORE_WORK_GROUP != &quot;&quot; and BEFORE_WORK_GROUP != null'>",
        "      AND BEFORE_WORK_GROUP = #{BEFORE_WORK_GROUP}",
        "    </if>",
        "    <if test='STATUS != &quot;&quot; and STATUS != null'>",
        "      AND STATUS = #{STATUS}",
        "    </if>",
        "    <if test='DISPLAY_TYPE != &quot;&quot; and DISPLAY_TYPE != null'>",
